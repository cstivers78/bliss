(function() {
  ...
  Writer = (function() {
    ...
    Writer.prototype.tag = function(tag, parent) {
      var c, index, _i, _len, _ref3, _ref4;
      switch (tag.name) {
        case 'Anchor':
        ...
        case 'Block':
          ...
          return this.code('}');
        case 'Group':
          if ((parent != null) && ((_ref4 = parent.name) === 'Block' || _ref4 === 'Func' || _ref4 === 'If' || _ref4 === 'For' || _ref4 === 'While' || _ref4 === 'DoWhile' || _ref4 === 'Invoke' || _ref4 === 'Parameters')) {
        ...
        case 'Func':
          ...
          return this.code('}');
        default:
          if (tag.parts != null) return this.parts(tag.parts(), tag);
      }
    };
