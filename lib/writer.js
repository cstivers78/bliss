...
Writer = (function() {
  ...
  Writer.prototype.tag = function(tag, parent) {
    var c, index, _i, _len, _ref, _ref2;
    switch (tag.name) {
      case 'Anchor':
      ...
      case 'Block':
        ...
        return this.code('}');
      case 'Group':
        if ((parent != null) && ((_ref2 = parent.name) === 'Block' || _ref2 === 'Func' || _ref2 === 'If' || _ref2 === 'For' || _ref2 === 'While' || _ref2 === 'DoWhile' || _ref2 === 'Invoke' || _ref2 === 'Parameters')) {
